...
class FilterModule(object):
    ...
    def cephmons(self, mons):
        ...
        {{ x | ska_collections.clusterapi.cephmons }}
        """
        # OLD FORMAT:!!!
        ...
        # NEW  FORMAT !!!
        # mon_host = [v2:10.165.4.17:3300/0,v1:10.165.4.17:6789/0] [v2:10.165.4.18:3300/0,v1:10.165.4.18:6789/0] [v2:10.165.4.19:3300/0,v1:10.165.4.19:6789/0]
    ...
    def cephmonsdata(self, mons):
        ...
        cephmonsdata filter
        integrate by adding FQ filter eg:
        {{ x | ska_collections.clusterapi.cephmonsdata }}
        """
    ...
    def cephmonitors(self, mons):
        ...
        cephmonitors filter
        integrate by adding FQ filter eg:
        {{ x | ska_collections.clusterapi.cephmonitors }}
        """
