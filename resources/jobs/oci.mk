.PHONY: oci-check-hosts vars docker containerd podman help
.DEFAULT_GOAL := help
...
oci-install: oci-check-hosts ## Install oci stack
	ansible-playbook $(PLAYBOOKS_DIR)/containers.yml \
	-i $(INVENTORY) $(ANSIBLE_PLAYBOOK_ARGUMENTS) $(ANSIBLE_EXTRA_VARS) \
	--extra-vars "target_hosts=$(PLAYBOOKS_HOSTS)"

oci-docker: oci-check-hosts ## Install docker
	ansible-playbook $(PLAYBOOKS_DIR)/docker.yml \
	-i $(INVENTORY) $(ANSIBLE_PLAYBOOK_ARGUMENTS) $(ANSIBLE_EXTRA_VARS) \
	--extra-vars "target_hosts=$(PLAYBOOKS_HOSTS)"

oci-containerd: oci-check-hosts ## Install containerd
	ansible-playbook $(PLAYBOOKS_DIR)/containerd.yml \
	-i $(INVENTORY) $(ANSIBLE_PLAYBOOK_ARGUMENTS) $(ANSIBLE_EXTRA_VARS) \
	--extra-vars "target_hosts=$(PLAYBOOKS_HOSTS)"

oci-podman: oci-check-hosts ## Install podman
